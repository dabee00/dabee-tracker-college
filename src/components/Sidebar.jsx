      ...
      <div className="flex items-center justify-between px-4 py-5 border-b border-blue-700">
        {sidebarOpen && (
          <div className="flex items-center gap-2">
            ...
            <div>
              <p className="font-bold text-sm leading-tight">SchoolTrack</p>
              <p className="text-blue-300 text-xs">Activity Manager</p>
            </div>
          </div>
        )}
        {!sidebarOpen && (
      ...
      <div className={`border-t border-blue-700 p-4 ${sidebarOpen ? '' : 'flex justify-center'}`}>
        {sidebarOpen ? (
          <div className="flex items-center gap-3">
            <div className="w-9 h-9 rounded-full bg-gradient-to-br from-yellow-400 to-orange-400 flex items-center justify-center font-bold text-white text-sm flex-shrink-0">
              JS
            </div>
            <div className="flex-1 min-w-0">
              <p className="text-white text-sm font-medium truncate">Juan Santos</p>
              <p className="text-blue-300 text-xs truncate">Grade 10 - Rizal</p>
            </div>
            <Bell className="w-4 h-4 text-blue-300 flex-shrink-0" />
          </div>
        ) : (
          <div className="w-9 h-9 rounded-full bg-gradient-to-br from-yellow-400 to-orange-400 flex items-center justify-center font-bold text-white text-sm">
            JS
          </div>
        )}
      </div>
